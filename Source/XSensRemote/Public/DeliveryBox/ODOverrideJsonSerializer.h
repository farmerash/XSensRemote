...
class XSENSREMOTE_API UODOverrideJsonSerializer : public UObject
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class XSENSREMOTE_API UODNoWriteTypeJsonSerializer : public UODOverrideJsonSerializer
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class XSENSREMOTE_API UODWriteTypeJsonSerializer : public UODOverrideJsonSerializer
{
	GENERATED_BODY()
